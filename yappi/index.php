...
<head>
	<meta charset="utf-8">
	<title>SMK Yappi Wonosari</title>
...
<body>
	...
	<header id="header">
		<div class="container">
			<a href="index.php" id="logo" title="YappiWonosariVocationalHigh">YappiWonosariVocationalHighSchool</a>
			<div class="menu-trigger"></div>
			<nav id="menu">
				<ul>
					<li><a href="index.php">Beranda</a></li>
					<li><a href="gallery.html">Siswa</a></li>
					<li><a href="events.html">Events</a></li>
					<li><a href="gallery.html">Ada Apa?</a></li>
 				</ul>
				<ul>
					<li><a href="gallery.html">Jurusan</a></li>
					<li><a href="gallery.html">Guru</a></li>
	...
	<footer id="footer">
		<div class="container">
			...
			<p class="copy">Copyright 2017 BBISY. Designed by <a href="http://www.inspirasiyappi.com/" title="Designed by BBISY" target="_blank">BBISY</a>. All rights reserved.</p>
		</div>
		<!-- / container -->
	</footer>
	<!-- / footer -->
